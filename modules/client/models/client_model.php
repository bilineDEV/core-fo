...
class client_model extends MY_Model {
  ...
  {
         return $this->db
                     ->select('tbl_clients.client_id, tbl_clients.client_account, tbl_clients.client_fullname, tbl_clients.client_group, tbl_group.group_name, tbl_group.group_tpl, tbl_officer.officer_name, tbl_area.area_name, tbl_branch.branch_name')
                     ->from('tbl_clients')
                     ->join('tbl_group', 'tbl_group.group_id = tbl_clients.client_group', 'left')
                     ->join('tbl_branch', 'tbl_branch.branch_id = tbl_clients.client_branch', 'left')
                     ->join('tbl_area', 'tbl_area.area_id = tbl_branch.branch_area', 'left')
