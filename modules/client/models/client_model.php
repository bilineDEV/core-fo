...
class client_model extends MY_Model {
  ...
  public function get_client_attendance_by_account($client_account)
  {
      return $this->db
                  ...
                  ->select('SUM(tbl_transaction.tr_absen_c) as client_cuti, SUM(tbl_transaction.tr_absen_i) as client_izin')
                  ->select('SUM(tbl_transaction.tr_absen_a) as client_absen, SUM(tbl_transaction.tr_tanggungrenteng) as client_tanggungrenteng')
